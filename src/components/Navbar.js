        ...
        <div className="container">
          ...
          <div id="navMenu" className={`navbar-menu ${this.state.navBarActiveClass}`}>
            ...
            <div className="navbar-end has-text-centered">
              <span className="navbar-item">01-4356221 vedanasoft@gmail.com</span>
              <a className="navbar-item" title="facebook" href="https://facebook.com/vedanasoft">
                <img src={facebook} alt="Facebook" style={{ width: '1em', height: '1em' }} />
              </a>
              <a className="navbar-item" title="instagram" href="https://instagram.com/vedanasoft">
